...
const SAMPLE_WORLD_SETTING_IDS = {
  gate: 'sample-ws-gate',
...
export function seedLocalSampleData(): void {
  localStorage.setItem('storycore_works', JSON.stringify([sampleWork]));
  localStorage.setItem('storycore_characters', JSON.stringify(sampleCharacters));
  localStorage.setItem('storycore_episodes', JSON.stringify(sampleEpisodes));
  localStorage.setItem('storycore_world_settings', JSON.stringify(sampleWorldSettings));
  localStorage.setItem('storycore_selected_work_id', SAMPLE_WORK_ID);
}
